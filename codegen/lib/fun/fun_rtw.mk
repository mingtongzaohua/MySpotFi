###########################################################################
## Makefile generated for MATLAB file/project 'fun'. 
## 
## Makefile     : fun_rtw.mk
## Generated on : Tue Oct 09 16:02:02 2018
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/zhanghao/Downloads/ChromeDonwnloads/ustc_hefei/mkotaru-spotfimusicaoaestimation-46080bc2ead8/codegen/lib/fun
ARCH                      = maci64
...
DEFINES_STANDARD = -DMODEL=fun -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/fun_initialize.c $(START_DIR)/fun_terminate.c $(START_DIR)/fun.c
...
OBJS = fun_initialize.o fun_terminate.o fun.o
