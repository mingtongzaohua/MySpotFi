 ...
 * Return Type  : void
 */
void fun_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray *plhs[1])
{
  real_T x;
  real_T y;
...
/*
 * File trailer for _coder_fun_api.c
 *
 * [EOF]
 */
